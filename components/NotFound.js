        ...
        <div className='flex flex-col items-center'>
          <div className='mb-8 inline-flex items-center gap-2.5'>
            <svg
              ...
              height='24'
              viewBox='0 0 100 100'
              className='h-6 fill-current hover:text-blue-500 dark:text-white'
            >
          ...
          <p className='mb-4 font-semibold uppercase text-sm md:text-base'>
            {t.ERROR.MESSAGE}
          </p>
          ...
          <p className='mb-12 max-w-screen-md text-center md:text-lg'>
            {t.ERROR.HELP_TEXT}
          </p>
