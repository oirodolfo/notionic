...
import * as tailwind from 'tailwindcss/defaultConfig'
import {pseudoPropNames, pseudoSelectors, t} from "@/lib/styled-utils"
// import { flexbox, grid } from "@/lib/styled-utils-definitions"
// import  type { ThemeConfig } from 'tailwindcss'
...
// )
//
// const layoutSystem = Object.assign({}, flexbox, grid)
...
export const elementsArray: (keyof JSX.IntrinsicElements)[] = [
    "a",
    "abbr",
    "address",
    "area",
...
const intrinsicElementsMap: IntrinsicElementsTemplateFunctionsMap = elementsArray.reduce(
...
export const Box = intrinsicElementsMap['div']
export default tw
