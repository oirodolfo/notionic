      ...
      {links
        ...
        .map((link) => (
          <li key={`${link.id}`}>
            <Link
              href={link.url}
              className='flex flex-row items-center p-3 text-base text-gray-900 rounded-lg bg-fuchsia-50/10 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white'
