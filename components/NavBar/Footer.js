...
import { BookOpenIcon, MailIcon, UserIcon, UsersIcon } from '@heroicons/react/outline'
      ...
      {links
        ...
        .map((link) => (
          <li key={`${link.id}`}>
            <Link
              href={link.url}
              className="flex flex-row items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"
            >
              {/* icon */}
  ...
  return (
    ...
    >
      <footer className="px-4 md:px-8 mx-auto">
        ...
        <div>
          <a className="twitter-timeline" data-theme="dark" data-tweet-limit="5" data-chrome="nofooter noborders"
             href="https://twitter.com/KistenRod?ref_src=twsrc%5Etfw">Tweets by KistenRod</a>
        </div>
